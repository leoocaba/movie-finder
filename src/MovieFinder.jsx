    ...
    <>
      <header className="__movie-finder-container container p-0 m-0">
        <div className="row p-0 m-0">
          <div className="__movie-finder container p-0 m-0">
            <h1 className="col text-center text-white mb-1 mt-3">
              Movie Finder
            </h1>
            <form
              className="d-flex justify-content-center mx-0 px-0 mb-3 mt-1"
              onSubmit={handleSubmit}
            >
              <div className="d-flex">
                <input
                  type="text"
                  className="form-control rounded-2 rounded-end-0"
              ...
              <div className="d-flex">
                <button
                  type="submit"
                  className="btn btn-inline-block rounded-2 rounded-start-0"
                >
                  Buscar
                </button>
              </div>
